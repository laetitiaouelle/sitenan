		...
		<section class="hero_single version_2">
			<div class="wrapper">
				<div class="container">
					...
					<p>Développer vos aptitudes en programmation web | Android | etc...</p>
					<form>
						<div id="custom-search-input">
							<div class="input-group">
								<input type="text" class=" search-query" placeholder="Ex. Php, Programmation orienté objet...">
			...
			<div class="container">
				<ul>
					<li><i class="pe-7s-study"></i>
						<h4>+200 cours</h4><span>Explore une variété de nouveaux cours</span>
					</li>
					<li><i class="pe-7s-cup"></i>
						<h4>Professeurs experimentés</h4><span>Trouve le bon prof pour toi</span>
					</li>
					<li><i class="pe-7s-target"></i>
						<h4>Focus sur la cible</h4><span>Augmentez votre expertise personnelle</span>
					</li>
				</ul>
			</div>
		</div>
